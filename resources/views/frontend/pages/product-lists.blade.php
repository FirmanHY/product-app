                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">Shop
                                    List</a></li>
                        </ul>
                    </div>
                </div>
                                ...
                                <div class="price-filter">
                                    <div class="price-filter-inner">
                                        ...
                                        <div class="product_filter">
                                            <button type="submit"
                                                class="filter_button">Filter</button>
                                            <div class="label-input">
                                                <span>Range:</span>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="shop-top">
                                    ...
                                    <ul class="view-mode">
                                        <li><a href="{{ route('product-grids') }}"><i
                        ...
                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-md-6 col-12">
                                                <div class="list-content">
                                                    ...
                                                    <p class="des pt-2">
                                                        {!! html_entity_decode($product->summary) !!}</p>
                            ...
                            @else
                                <h4 class="text-warning"
                                    style="margin:100px auto;">There are no
                                    products.</h4>
                            @endif
                        </div>
                        <div class="row">
