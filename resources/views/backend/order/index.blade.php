    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                @if (count($orders) > 0)
                    <table class="table table-bordered" id="order-dataTable"
                    ...
                    <span
                        style="float:right">{{ $orders->links('vendor.pagination.custom') }}</span>
                @else
                    <h6 class="text-center">No orders found!!! Please order some
                        products</h6>
                @endif
            </div>
        </div>
