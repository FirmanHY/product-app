...
@section('title', 'F-SHOP || Edit Product')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="post" action="{{ route('product.update', $product->id) }}">
                ...
                <div class="form-group">
                    ...
                    <select name="size[]" class="form-control selectpicker"
                        ...
                        @foreach ($items as $item)
                            ...
                            @endphp
                            <option value="S"
                                @if (in_array('S', $data)) selected @endif>
                                Small</option>
                            <option value="M"
                                @if (in_array('M', $data)) selected @endif>
                                Medium</option>
                            <option value="L"
                                @if (in_array('L', $data)) selected @endif>
                                Large</option>
                            <option value="XL"
                                @if (in_array('XL', $data)) selected @endif>
                                Extra Large</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="form-group">
                    <label for="stock">Quantity <span
                            class="text-danger">*</span></label>
                    <input id="quantity" type="number" name="stock"
...
@push('styles')
    <link rel="stylesheet"
        href="{{ asset('backend/summernote/summernote.min.css') }}">
    <link rel="stylesheet"
